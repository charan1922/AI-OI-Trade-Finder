...
const base: SuggestResponse = {
  ...
  suggestions: [
    ...
    mk({
      ...
      factors: { vwap: 561.17, vwapAligned: true, supertrend: 'down', supertrendLine: 565.9, supertrendAligned: false, atr: 1.9, atrPct: 0.34, eqTurnoverRatio: 2.2, combinedOiLevel: 1.78, nseOiPct: 3.1, combinedOiSlope30m: -1.6, onOiSpurtList: false, sectorPct: -0.27, sectorAdvanceRatio: 0.4, sectorAligned: false, gexRegime: 'positive', gexValue: 12500, gexWall: 25000 },
...
const later: SuggestResponse = {
  ...
  suggestions: [
    mk({
      ...
      factors: { vwap: 1401.4, vwapAligned: true, supertrend: 'up', supertrendLine: 1402.1, supertrendAligned: true, atr: 4.6, atrPct: 0.32, eqTurnoverRatio: 4.4, combinedOiLevel: 1.19, nseOiPct: 6.9, combinedOiSlope30m: -0.9, onOiSpurtList: true, sectorPct: 1.8, sectorAdvanceRatio: 0.7, sectorAligned: true, gexRegime: 'positive', gexValue: 12500, gexWall: 25000 },
    }),
  ],
};
