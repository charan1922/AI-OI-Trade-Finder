...
export const COMMENTARY_SYSTEM = [
  ...
  '`tf` on a pick is TradeFinder\'s INDEPENDENT rank for the same name. Their R-Factor measures the SIZE',
  ...
  'to confirm that something worth trading is happening in the name; direction stays with our own',
  'evidence (breakout, VWAP/Supertrend, OI flow). A low rank means thin institutional interest, not a',
  'bearish call. null/absent means they have no data today — no second opinion, never a rejection.',
  'Never call a trade because TF ranks it; the trader only ever acts on names in `suggestions`.',
