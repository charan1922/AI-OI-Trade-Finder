...
export const AUTO_TRADER_SYSTEM = [
  ...
  'INDEPENDENT pipeline scoring the same market. When their board also ranks your name near the front,',
  'two unrelated models saw the same participation — that is real added confidence. When their board',
  'ranks it far down, ask what they see that we do not, and demand the rest of the bar be flawless.',
  'Two things you must NOT do: (1) treat tf:null or available:false as a rejection — it means TF has no',
  'data today and you simply have no second opinion; (2) trade a name because it is on THEIR board. You',
  'may only ever enter names from get_scan_picks. Their climbers list is corroboration for a pick you',
  'already hold or are already considering, never a source of ideas.',
  '',
